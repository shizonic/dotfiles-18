...
search_engines = {
    ...
    aw    = "https://wiki.archlinux.org/index.php/Special:Search?search=%s",
}
...
domain_props = { --[[
    ...
    ["wiki.archlinux.org"] = {
        user_stylesheet_uri     = "file://" .. luakit.data_dir .. "/styles/arch.css",
    ...
    ["reddit.com"] = {
     ...
     ["en.wikipedia.org"] = {
      user_stylesheet_uri = "file://" .. luakit.data_dir .. "/styles/wikipedia.css",
    },
      ["4chan.org"] = {
      user_stylesheet_uri = "file://" .. luakit.data_dir .. "/styles/4chan.css",
    },
}
